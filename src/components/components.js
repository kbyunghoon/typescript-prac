...
import BoardChildComment from 'components/trilog/BoardChildComment';
import BoardWriteMap from 'components/trilog/BoardWriteMap';
import BoardDetailMap from 'components/trilog/BoardDetailMap';

export { BoardCard, BoardView, BoardComment, BoardWriteMap, BoardDetailMap, BoardChildComment };